class Alphabet:
    ...
    def convert_blocks_to_numerical_equivalents(self, blocks: list[str]) -> list[int]:
        ...
        for block in blocks:
            numerical_equivalents.append(self.__convert_a_block_to_numerical_equivalent(block))
        return numerical_equivalents

    def __convert_a_block_to_numerical_equivalent(self, block: str) -> int:
    ...
    def convert_numerical_equivalents_to_blocks(self, numerical_equivalents: list[int], step: int) -> list[str]:
        ...
        for numerical_equivalent in numerical_equivalents:
            blocks.append(self.__convert_a_numerical_equivalent_to_block(numerical_equivalent, step))
        return blocks

    def __convert_a_numerical_equivalent_to_block(self, numerical_equivalent: int, step: int) -> str:
